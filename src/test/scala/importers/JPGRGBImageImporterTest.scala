...
import importers.image.fileRGBImageImporters.JPGRGBImageImporter
import org.scalatest.funsuite.AnyFunSuite

import java.awt.Color

class JPGRGBImageImporterTest extends AnyFunSuite {
  test("Loading incorrect extension") {
    val path = """assets/test/images/test3x1.png"""
    val importer = new JPGRGBImageImporter(path)
